                ...
                <div label="Historia">
                  <div className="row justify-content-center">
                    <div className="col-lg-9">
                      ...
                      <p className="main-text navy">El 04 de septiembre del año de 2012 en la ciudad de Tegucigalpa, capital de Honduras se reactivó la Cámara Hondureña de la Leche, bajo la iniciativa de un grupo de productores de diferentes regiones del país, siendo la Junta Directiva integrada por: <strong>Presidente</strong> Ing. Anabel Gallardo, <strong>Vicepresidente</strong> Ing. Luis Arturo Donaire, <strong>Tesorero</strong> Ing. Héctor Alberto Ferreira Sabillón, <strong>Secretario</strong> Miguel Ángel Arévalo, <strong>Vocal I</strong> Vicente Murillo Cabrera, <strong>Vocal II</strong> Leopoldo Duran, <strong>Vocal III</strong> Jose Luis Gallardo, <strong>Vocal IV</strong> Mario Sánchez; y la <strong>Junta Fiscalizadora</strong> Paolo Santalena, Dionisio Acosta, Carlos Estrada.</p>
                    </div>
                  </div>
                </div>
