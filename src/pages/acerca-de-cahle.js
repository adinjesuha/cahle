            ...
            <div className="col-lg-12">
              <Tabs>
                ...
                <div label="Objetivos">
                  <div className="row justify-content-center">
                    <div className="col-lg-9">
                      <h2 className="main-title">Objetivos Generales</h2>
                    ...
                    <div className="col-lg-9">
                      ...
                      <div className="row justify-content-center">
                        <div className="col-lg-6">
                          <h3 className="sub-title"><span className="number">01</span>Apoyar</h3>
                          <p className="main-text">Apoyar a sus asociaciones en la búsqueda de mejores niveles de eficiencia individual y empresarial, para mejorar su capacidad para producir bienes y servicios de carácter agroindustrial con valor agregado.</p>  
                        </div>
                        <div className="col-lg-6">
                          <h3 className="sub-title"><span className="number">02</span>Informar</h3>
                          <p className="main-text">Lograr que todos los asociados(as) y sus familias conozcan, hagan uso y se beneficien de las oportunidades y facilidades que ofrece la asociación.</p>
                        </div>
                        <div className="col-lg-6">
                          <h3 className="sub-title"><span className="number">03</span>Fomentar</h3>
                          <p className="main-text">Fomentar y estimular la producción, la comercialización y el consumo de leche, a través de la crianza de razas apropiadas de ganado bovino para mejorar la ganadería nacional.</p>
                        </div>
                        <div className="col-lg-6">
                          <h3 className="sub-title"><span className="number">04</span>Promover</h3>
                          <p className="main-text">Promover la investigación aplicada a todo el sistema productivo de ganado de leche, incluyendo la alimentación y nutrición, manejo de pastos y forrajes, mejoramiento genético, procesamiento, mercadeo y otros.</p>
                        </div>
                      </div>  
                    </div>
                  </div>
