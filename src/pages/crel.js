    ...
    <Layout>
      ...
      <Wrapper>
        <Container>
          ...
          <ul>
            <li>Barrios, C. 2008. Estudio de mercado de productos pecuarios en tres zonas piloto del proyecto “Desarrollo Participativo de Alternativas de Uso Sostenible de la Tierra para Áreas de Pasturas Degradadas en América Central” (Proyecto NORUEGA-PD). 108 p. (Serie Técnica, Informe Técnico no. 371). Disponible en <a style={{color: "var(--blue)"}} target="_blank" rel="noopener noreferrer" href="http://orton.catie.ac.cr/repdoc/A2694e/A2694e.pdf">http://orton.catie.ac.cr/repdoc/A2694e/A2694e.pdf</a></li>
