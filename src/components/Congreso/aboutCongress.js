...
const AboutCongress = () => (
  <div>
    <Wrapper>
      ...
      <p className="main-text navy">La cadena láctea es un importante segmento de la economía nacional ya que constituye uno de los encadenamientos productivos más importantes al generar múltiples beneficios en el desarrollo de las comunidades.</p>
      <p className="main-text navy">Año con año la Cámara Hondureña de la Leche (CAHLE) realiza el Congreso Nacional de la Leche y reúne a cientos de productores-ganaderos de todo el país, procesadoras de leche, diferentes empresas del sector público y privadas influyentes del sector agropecuario y agroindustrial en cuanto a equipos, bienes y servicios se refiere, además del mundo académico, técnicos y extensionistas en producción primaria, altos ejecutivos y dirigentes gremiales, investigadores, representantes del gobierno, entre otros.</p>
      ...
      <p className="main-text navy">La organización del IX Congreso espera recibir a más de 500 invitados entre nacionales y extranjeros y contará con una feria industrial y comercial en la que diferentes empresas presentarán equipos y suministros novedosos para el sector.</p>
    </Wrapper>
    <SubscriptionLink />
  </div>
)
